class Product {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'unit': unit,
      'market': market,
      'healthScore': healthScore,       // Yeni alan eklendi
      'ingredientsNote': ingredientsNote, // Yeni alan eklendi
    };
  }

  // Veritabanından gelen veriyi nesneye çeviriyoruz
  factory Product.fromMap(Map<String, dynamic> map) {
    return Product(
      ...
      unit: map['unit'],
      market: map['market'],
      // Veritabanında eski kayıtlarda null gelirse hata vermemesi için koruma (??) ekledik
