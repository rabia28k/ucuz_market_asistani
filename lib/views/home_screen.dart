...
import '../viewmodels/cart_provider.dart'; // 🎯 1. DÜZELTME: Eksik olan CartProvider import edildi!
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // --- ANONİM KULLANICI MENÜSÜ (DRAWER) ---
      drawer: Drawer(
        child: ListView(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // =======================================================
                  // 🎯 2. DÜZELTİLDİ: CANLI SEPET İÇİN SEPET HOCASI (CartProvider) BAĞLANDI
                  // =======================================================
                  Consumer<CartProvider>( // 🎯 ProductProvider yerine CartProvider yapıldı!
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    "${provider.cartItems.length} Ürün", // 🎯 Gerçek sepet uzunluğu bağlandı
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${provider.totalCartPrice.toStringAsFixed(2)} TL", // 🎯 Gerçek canlı sepet fiyatı bağlandı
                  ...
                  SizedBox(
                    ...
                    child: ListView(
                      ...
                      children: [
                        // 🎯 DÜZELTİLDİ: Kategorilerin veri tabanındaki tam isim karşılıkları parametre olarak gönderildi
  ...
  // 🎯 DÜZELTİLDİ: categoryName parametresi eklendi ve constructor'a bağlandı
